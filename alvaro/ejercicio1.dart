  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) => Card(
        ...
        child: ListTile(
          leading: const Icon(Icons.location_city, color: Color(0xFFD52B1E)), // Rojo Chile
          title: Text(_items[i], style: const TextStyle(fontWeight: FontWeight.bold)),
              ...
              child: _results.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (_, i) => ListTile(
                        leading: const Icon(Icons.place, color: Color(0xFF0039A6)),
    ...
    return Card(
      child: Center(
        child: Column(
          ...
          children: [
            Icon(icon, size: 40, color: const Color(0xFF0039A6)), // Iconos Azules
